...
const dataSource = {
  ...
  previewCarouselPlaces : {
    carouselPlaceOne: {
      name: '" Rzeszowskei Wały "',
      image: 'https://i.postimg.cc/8zgQSByr/Preview-Foto-2.jpg'
    },
    carouselPlaceOne: {
      name: '" Bulwary "',
      image: 'https://i.postimg.cc/tg9K1RGq/Preview-Foto-3.jpg'
    },
    carouselPlaceOne: {
      name: '" Lisia Góra "',
      image: 'https://i.postimg.cc/RZ1rV68p/Preview-Foto-4.jpg'
    },
    carouselPlaceOne: {
      name: '" Galeria Rzeszów "',
      image: 'https://i.postimg.cc/N0bWRhQ1/Preview-Foto-5.jpg'
    }
  },
