const dataSource = {
  ...
  entertainItems: [
    ...
    },
    {
      ...
      description: `Experience Rzeszów's vibrant nightlife! Dance the night away in clubs and bars, with pulsating beats and lively atmospheres. From trendy clubs to cozy pubs with live music.
    ...
    },
    {
      ...
      description: `Explore Rzeszów's serene lakes and rivers. Whether you seek tranquility on a peaceful lake or adventure along a winding river,
      Discover the wonders of Rzeszów's waterscapes and connect with nature.`
    },
    {
      id: 'skatepark',
      icon: "fa-solid fa-person-skating",
      image: 'https://i.postimg.cc/6qbF219c/Entertain-Foto-5.jpg',
      description: `Rzeszów is a haven for skateboarders and extreme sports enthusiasts.
    ...
    },
    {
      ...
      description: `Escape into the world of film at Rzeszów's cinemas.
